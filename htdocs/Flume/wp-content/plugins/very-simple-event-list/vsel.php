...
function vsel_metabox_callback( $post ) {
	...
	<input class="widefat" id="vsel-time" type="text" name="vsel-time" maxlength="500" placeholder="<?php esc_attr_e( 'Example: 16:00 - 18:00', 'very-simple-event-list' ); ?>" value="<?php echo esc_attr( $time ); ?>" /></p>
	<p><label for="vsel-location"><?php esc_attr_e( 'Location', 'very-simple-event-list' ); ?></label>
	<input class="widefat" id="vsel-location" type="text" name="vsel-location" maxlength="500" placeholder="<?php esc_attr_e( 'Example: Times Square', 'very-simple-event-list' ); ?>" value="<?php echo esc_attr( $location ); ?>" /></p>
	<p><label for="vsel-link"><?php esc_attr_e( 'Link to more info', 'very-simple-event-list' ); ?></label>
	<input class="widefat" id="vsel-link" type="text" name="vsel-link" maxlength="500" placeholder="<?php esc_attr_e( 'Example: www.wordpress.org', 'very-simple-event-list' ); ?>" value="<?php echo esc_url( $link ); ?>" /></p>
	<p><label for="vsel-link-label"><?php esc_attr_e( 'Link label', 'very-simple-event-list' ); ?></label>
	<input class="widefat" id="vsel-link-label" type="text" name="vsel-link-label" maxlength="500" placeholder="<?php esc_attr_e( 'Example: More info', 'very-simple-event-list' ); ?>" value="<?php echo esc_attr( $link_label ); ?>" /></p>
	...
	<textarea id="vsel-summary" name="vsel-summary" class="large-text" rows="6" maxlength="1500" placeholder="<?php esc_attr_e( 'This will replace the default summary', 'very-simple-event-list' ); ?>"><?php echo wp_kses_post( $summary); ?></textarea></p>
	<?php
}
